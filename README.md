...
- **Control Drift Attribution**: explains whether score movement came from evidence, policy, collector coverage, lifecycle, or exception changes
- **Policy Pack Changelog**: machine-readable policy change trail for policy drift explanation
- **Report Trust Badge**: compact stakeholder-facing assurance label backed by replay, RBOM, conformance, and evidence-gap signals
- **Decision Review Queue**: explicit governance queue for remediation, evidence review, exception review, and monitoring decisions
- **Decision Provenance Graph**: graph of evidence, policy, finding, score, replay, RBOM, assurance, and review decision relationships
- **Claim Verification Packs**: verifiable executive, compliance, and insurance claims linked to evidence, provenance, and RBOM artifacts
- **Assurance Case Builder**: structured trust argument linking top claims, supporting claims, evidence, provenance, caveats, and residual gaps
- **Claim-Bound Narrative**: stakeholder prose generated only from cited verified/caveated claim IDs
- **Customer-Facing Assurance Portal**: static trust view for assurance case, claims, provenance paths, replay, RBOM, and caveats
...
- [Control Drift Attribution](docs/control-drift-attribution.md)
- [Policy Pack Changelog](docs/policy-pack-changelog.md)
- [Report Trust Badge](docs/report-trust-badge.md)
- [Decision Review Queue](docs/decision-review-queue.md)
- [Decision Provenance Graph](docs/decision-provenance-graph.md)
- [Claim Verification Pack](docs/claim-verification-pack.md)
- [Assurance Case](docs/assurance-case.md)
- [Claim-Bound Narrative](docs/claim-bound-narrative.md)
- [Assurance Portal](docs/assurance-portal.md)
