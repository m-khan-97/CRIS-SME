...
| `20260601004646` | Weak IoMT baseline | `uaenorth` | `cris-lab-iomt-weak-baseline-20260601004646` | deleted by paper suite | `outputs/evidence-lab/20260601004646/iomt-weak-baseline/reports/cris_sme_report.json` | `outputs/evidence-lab/20260601004646/iomt-weak-baseline/reports/cris_iomt_evidence_pack.md` | Post-review suite run: 10 `IOT-*` findings, Healthcare IoT score `26.40`; public access, no telemetry route, and no alert rule all detected. |
| `20260601004646` | Simulated clinic | `uaenorth` | `cris-lab-iomt-simulated-clinic-20260601004646` | deleted by paper suite | `outputs/evidence-lab/20260601004646/iomt-simulated-clinic/reports/cris_sme_report.json` | `outputs/evidence-lab/20260601004646/iomt-simulated-clinic/reports/cris_iomt_evidence_pack.md` | Post-review suite run: 9 `IOT-*` findings, Healthcare IoT score `27.08`; alerting passes while public exposure and telemetry routing still fire. |
| `20260601004646` | Hardened clinic | `uaenorth` | `cris-lab-iomt-hardened-clinic-20260601004646` | deleted by paper suite | `outputs/evidence-lab/20260601004646/iomt-hardened-clinic/reports/cris_sme_report.json` | `outputs/evidence-lab/20260601004646/iomt-hardened-clinic/reports/cris_iomt_evidence_pack.md` | Post-review suite run: 6 `IOT-*` findings, Healthcare IoT score `25.19`; `IOT-005`, `IOT-006`, `IOT-007`, and `IOT-009` pass. |
...
- `IOT-005`, `IOT-006`, `IOT-007`, and `IOT-009` are the strongest controlled signals in the post-review suite: the weak baseline fired all four; the hardened clinic passed all four after public IoT Hub access was disabled, uncompensated public ingestion was removed, telemetry storage routing was added, and a real Azure Monitor metric alert was deployed.
...
- Temporary lab resources were created, assessed, and deleted by `scripts/azure_evidence_lab.py cycle` or `paper-iomt-suite`.
